...
# wget http://jenkins01:8080/jnlpJars/jenkins-cli.jar
# java -jar jenkins-cli.jar -s http://jenkins01:8080/ -auth MaitreWaff:1146ebe1632004ca613d8475abb5575e4b
# java -jar jenkins-cli.jar -s http://jenkins01:8080/ -auth MaitreWaff:1146ebe1632004ca613d8475abb5575e4b -webSocket list-jobs
# java -jar jenkins-cli.jar -s http://jenkins01:8080/ -auth MaitreWaff:1146ebe1632004ca613d8475abb5575e4b -webSocket build test-pipeline
