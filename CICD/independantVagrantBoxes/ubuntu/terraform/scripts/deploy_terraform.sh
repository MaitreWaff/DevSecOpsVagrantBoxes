...
echo "---------------- Setup Terraform Server ------------------"

print_color "green" "[+] Beginning Of deploy_terraform.sh ..."

# Latest from https://developer.hashicorp.com/terraform/tutorials/docker-get-started/install-cli
...
# Course Version 0.13.0

# Download and unzip terraform_0.13.0
print_color "green" "[+] Downloading Terraform ..."
wget https://releases.hashicorp.com/terraform/0.13.0/terraform_0.13.0_linux_amd64.zip
unzip terraform_0.13.0_linux_amd64.zip

# Moving terraform binary to /usr/local/bin
print_color "green" "[+] Moving Terraform binary to /usr/local/bin/ folder ..."

mv terraform /usr/local/bin
ls -lh /usr/local/bin/terraform

# # Install and configure firewalld
print_color "green" "[+] Deleting Terraform zip ..."
rm -rf terraform_0.13.0_linux_amd64.zip

# # Install and configure firewalld
print_color "green" "[+] Printing Terraform Version ..."
terraform version


print_color "green" "[+] End Of deploy_terraform.sh ..."
# # Install and configure firewalld
