...
echo "---------------- Setup App Server ------------------"

# Creating Deployment User to the System
print_color "green" "[+] Adding deployment-user User to run the application... "

# sudo adduser deployment-user
# echo djangoDeploymentPassword | sudo passwd deployment-user --stdin
# sudo usermod -aG sudo deployment-user

# # Upgrading PIP
# print_color "green" "[+] Upgrading pip3 Python Package Manager... "
